...
BEGIN
  ...
  BEGIN
    INSERT INTO public.appointments (senior_id, service_type, appointment_date, status, notes, location)
    VALUES (p_senior_id, p_service_type, v_appointment_date, 'Scheduled', p_notes, p_location);
...
ON public.appointments (
  ((appointment_date AT TIME ZONE 'Asia/Manila')::date),
  (EXTRACT(HOUR FROM appointment_date AT TIME ZONE 'Asia/Manila')),
  (EXTRACT(MINUTE FROM appointment_date AT TIME ZONE 'Asia/Manila'))
)
